...
def apiUrl = 'http://127.0.0.1:8088/postadmin/postcryption/mock/rsa'
def plaintext = 'hello-rsa'
...
def requestMap = [
        ...
        ciphertext: PostcryptionUtils.rsaEncryptToBase64(keyPair.publicKey, plaintext)
]
