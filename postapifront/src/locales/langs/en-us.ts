const local: App.I18n.Schema = {
  ...
  route: {
    ...
    about: 'About',
    postadmin: 'PostAdmin',
    postadmin_dashboard: 'Dashboard',
    postadmin_definitions: 'API Definitions',
    postadmin_groups: 'API Groups',
    postadmin_groovy: 'Groovy Engine',
    postadmin_logs: 'Logs',
    postadmin_runtime: 'Runtime',
    postadmin_tenants: 'Tenants',
