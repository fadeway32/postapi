...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  postadmin_dashboard: () => import("@/views/postadmin/dashboard/index.vue"),
  postadmin_definitions: () => import("@/views/postadmin/definitions/index.vue"),
  postadmin_groovy: () => import("@/views/postadmin/groovy/index.vue"),
  postadmin_groups: () => import("@/views/postadmin/groups/index.vue"),
  postadmin_logs: () => import("@/views/postadmin/logs/index.vue"),
  postadmin_runtime: () => import("@/views/postadmin/runtime/index.vue"),
  postadmin_tenants: () => import("@/views/postadmin/tenants/index.vue"),
